...
def methodParametersFinderForEnumeration(node, className, class_methods):
    ...
    with open('Output/Method Parameters_Enumeration.csv', 'a', newline='') as file:
        writer = csv.writer(file, dialect='excel')
...
def methodLocalVariablesTypeFinderForEnumeration(node, className, class_methods):
    ...
    with open('Output/Method Local Variables_Enumeration.csv', 'a', newline='') as file:
        writer = csv.writer(file, dialect='excel')
...
def methodLocalAssignmentsFinderForEnumeration(node, className, class_methods):
    ...
    method_structures = []
    EnumerationAttributesPath = 'Output/Enumeration Attributes.csv'
    
    with open('Output/Method Local Identifiers_Enumeration.csv', 'a', newline='') as file:
        writer = csv.writer(file, dialect='excel')
...
def sensitiveClassCheck():
    ...
    inputPath = ['Output/Class Attributes.csv', 'Output/Interface Attributes.csv', 'Output/Enumeration Attributes.csv']
    outputPath = ['Output/Sensitive Classes.csv', 'Output/Sensitive Interfaces.csv', 'Output/Sensitive Enumerations.csv']
...
def sensitiveMethodParametersCheck():
    ...
    inputPath = ['Output/Method Parameters_Class.csv', 'Output/Method Parameters_Interface.csv', 'Output/Method Parameters_Enumeration.csv ']
    outputPath = ['Output/Sensitive Parameters-Based Methods_Class.csv', 'Output/Sensitive Parameters-Based Methods_Interface.csv', 'Output/Sensitive Parameters-Based Methods_Enumeration.csv']
...
def sensitiveMethodLocalVariablesTypeCheck():
    ...
    sensitiveClassesPath = 'Output/Sensitive Classes.csv'
    inputPath = ['Output/Method Local Variables_Class.csv', 'Output/Method Local Variables_Enumeration.csv']
    outputPath = ['Output/Sensitive Local Variables-Based Methods_Class.csv', 'Output/Sensitive Local Variables-Based Methods_Enumeration.csv']
...
def sensitiveMethodLocalAssignmentsCheck():
    ...
    sensitiveClassesPath = ['Output/Sensitive Classes.csv', 'Output/Sensitive Enumerations.csv']
    inputPath = ['Output/Method Local Identifiers_Class.csv', 'Output/Method Local Identifiers_Enumeration.csv']
    outputPath = ['Output/Sensitive Local Identifiers-Based Methods_Class.csv', 'Output/Sensitive Local Identifiers-Based Methods_Enumeration.csv']
